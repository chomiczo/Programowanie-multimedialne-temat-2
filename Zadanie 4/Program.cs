...
namespace PMLabs
{
    ...
    class Program
    {
        ...
        public static void InitOpenGLProgram(Window window)
        {
            ...
            GL.Enable(EnableCap.DepthTest); //uzupełnia brakujące elementy po zmianie na spLambert i po cieniowaniu Z-Bufor
        ...
        public static void DrawScene(Window window, float angle_x, float angle_y)
        {
            ...
            GL.UniformMatrix4(DemoShaders.spLambert.U("P"), 1, false, P.Values1D); //zmiana wszędzie na spLambert
            ...
            GL.Uniform4(DemoShaders.spLambert.U("color"), 0.5645f, 0.72f, 0.945f, 1f); //zmiana koloru
     

            torus.drawSolid(); //zmiana na solid daje wypełnienie obiektu
